...
<body>
    ...
    <div id="wrapper">
            ...
            <ul class="list-unstyled topnav-menu float-right mb-0">
                ...
                <li class="dropdown notification-list">
                    <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <img src="<?= base_url() ?>/img/<?= user()->image == null ? 'default.jpg' : user()->image ?>" alt="user-image" class="rounded-circle">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                        ...
                        <?php if (in_groups('pelamar')) { ?>
                            <a href="<?= base_url('/pelamar/profile/' . user()->username . ''); ?>" class="dropdown-item notify-item">
                                <i class="dripicons-user"></i>
                                <span>My Account</span>
                            </a>
                        <?php } elseif (in_groups('perusahaan')) { ?>
                            <a href="<?= base_url('/perusahaan/profile/' . user()->username . ''); ?>" class="dropdown-item notify-item">
                                <i class="dripicons-user"></i>
                                <span>My Account</span>
                            </a>
                        <?php } ?>
        ...
        <?php } elseif (in_groups('perusahaan')) { ?>
            <?= $this->include('perusahaan/sidebar/index') ?>
        <?php } ?>
