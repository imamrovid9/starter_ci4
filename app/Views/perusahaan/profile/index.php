...
<div class="card">
    <div class="card-body">
        ...
        <form action="<?= base_url('perusahaan/profile/' . user()->username) ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
            ...
            <div class="row ">
                ...
                <div class="col-md-6">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-10">
                            <label for="description_perusahaan">Description Perusahaan</label>
                            <textarea name="description_perusahaan" id="" cols="30" rows="10" class="form-control"><?= $user->description ?></textarea>
                        </div>
                    </div>
